...
const COPY = {
  "zh-CN": {
    ...
    language: "界面语言", languageHint: "切换界面显示的中文字体（简体/繁体）", simplified: "简体中文", simplifiedHint: "使用简体中文显示界面", traditional: "繁體中文", traditionalHint: "使用繁體中文顯示界面", english: "English", englishHint: "Use English for the interface",
  ...
  "zh-TW": {
    ...
    language: "介面語言", languageHint: "選擇此帳戶使用的介面語言。", simplified: "简体中文", simplifiedHint: "使用简体中文显示界面", traditional: "繁體中文", traditionalHint: "使用繁體中文顯示界面", english: "English", englishHint: "使用英文顯示介面",
  ...
  en: {
    ...
    language: "Interface language", languageHint: "Choose the interface language for this account.", simplified: "简体中文", simplifiedHint: "Use Simplified Chinese", traditional: "繁體中文", traditionalHint: "Use Traditional Chinese", english: "English", englishHint: "Use English for the interface",
...
const localeOptions: Array<{ value: AppLocale; key: "simplified" | "traditional" | "english"; hintKey: "simplifiedHint" | "traditionalHint" | "englishHint" }> = [
  { value: "zh-CN", key: "simplified", hintKey: "simplifiedHint" }, { value: "zh-TW", key: "traditional", hintKey: "traditionalHint" },
  { value: "en", key: "english", hintKey: "englishHint" },
];
...
export function DisplaySettings({ mode = "standard" }: Readonly<{ mode?: "standard" | "premium" }>) {
  ...
  return <SettingsSection id="display" title={copy.title}>
    <div className="preference-stack">
      ...
      <div className="preference-group display-language-settings"><h3>{copy.language}</h3><p>{copy.languageHint}</p><div className="preference-grid">
        {localeOptions.map((option) => <Choice key={option.value} active={locale === option.value} title={copy[option.key]} detail={copy[option.hintKey]}
